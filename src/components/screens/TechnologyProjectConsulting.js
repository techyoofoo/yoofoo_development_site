...
export default class TechnologyProjectConsultingscreen extends Component {
            ...
            <div>
                ...
                <HeaderMenuscreen />
                    ...
                    <div className="row innerContent">
                        <div>
                            <div className="headingAbout">Technology <span className="headingAbout1">Project Consulting </span></div>
