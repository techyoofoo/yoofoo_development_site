...
export default class DigitalTransformationStrategiesscreen extends Component {    
    render() {
        const BASE_URL = '#'
        return (
            <div>
                ...
                <HeaderMenuscreen />
                    ...
                    <div className="row innerContent">
                        <div>
                            <div className="headingAbout">Digital<span className="headingAbout1">Transformation Strategies </span></div>
