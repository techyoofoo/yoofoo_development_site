...
export default class Bfsiscreen extends Component {
    render() {
        const BASE_URL = '#'
        return (
            <div>
                <div>
                    ...
                    <div className="row innerContent">
                        <div>
                            <div className="headingAbout">BANKS, FINANCIAL <span className="headingAbout1">SERVICES AND INSURANCE</span></div>
